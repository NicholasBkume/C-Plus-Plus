...
int main()
{
   ...
   // the values entered.
   FinalExam test3(questions, missed);

   // Display the adjusted test results.
   cout << setprecision(2) << fixed;
   cout << "\nEach question counts " << test3.getPointsEach() << " points.\n";
   cout << "The adjusted exam score is " << test3.getScore() << endl;
   cout << "The exam grade is " << test3.getLetterGrade() << endl;
